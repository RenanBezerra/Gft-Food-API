...
values (1,'62709a7f-7ba0-4e9f-ac3b-509a2fe8384a',1,1,1,1, '38400-000', 'Rua Floriano Peixoto', '500','Apto 801','Brasil',
...
insert into item_pedido(id,pedido_id, produto_id, quantidade, preco_unitario, preco_total, observacao)
values(2,1,2,2,110,220,'Menos picante');


insert into pedido(id,codigo, restaurante_id, usuario_cliente_id, forma_pagamento_id, endereco_cidade_id, endereco_cep,
	endereco_logradouro,endereco_numero, endereco_complemento, endereco_bairro,
	status, data_criacao, subtotal, taxa_frete, valor_total)
values(2,'d5d710c1-0d4f-4e48-b1da-dd028b424d17',4,1,2,1,'38400-111','Rua Acre', '300', 'Casa 2', 'Centro',
