...
insert into permissao (id, nome, descricao) values (2, 'EDITAR_COZINHAS', 'Permite criar ou editar cozinhas');
...
insert into permissao (id, nome, descricao) values (12, 'EDITAR_RESTAURANTES', 'Permite criar ou editar restaurantes');
