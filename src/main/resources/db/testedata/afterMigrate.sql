...
insert into permissao (id, nome, descricao) values (1, 'EDITAR_COZINHAS', 'Permite criar ou editar cozinhas');
...
insert into permissao (id, nome, descricao) values (5, 'CONSULTAR_USUARIOS_GRUPOS_PERMISSOES', 'Permite consultar usuarios');
insert into permissao (id, nome, descricao) values (6, 'EDITAR_USUARIOS_GRUPOS_PERMISSOES', 'Permite criar ou editar usuarios');
insert into permissao (id, nome, descricao) values (7, 'EDITAR_RESTAURANTES', 'Permite criar ou editar restaurantes');
...
(1, 'João da Silva', 'joao.ger@algafood.com', '$2y$12$ttOL7r6bZu5FeMKnYpuaweOsb42eKfoqL4CqKMf58lcvnDpj8nxa.', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2y$12$ttOL7r6bZu5FeMKnYpuaweOsb42eKfoqL4CqKMf58lcvnDpj8nxa.', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '$2y$12$ttOL7r6bZu5FeMKnYpuaweOsb42eKfoqL4CqKMf58lcvnDpj8nxa.', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com', '$2y$12$ttOL7r6bZu5FeMKnYpuaweOsb42eKfoqL4CqKMf58lcvnDpj8nxa.', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2y$12$ttOL7r6bZu5FeMKnYpuaweOsb42eKfoqL4CqKMf58lcvnDpj8nxa.', utc_timestamp),
...
values (
	'gftfood-web', null, '$2y$12$NB5BUOP2wkPfHIrIpaFLIehu2z/ko9cEDvNR9gC5eyQ2hbOe2.e1a',
...
values (
	'foodanalytics', null, '$2y$12$JReicUraBF6lMwy6.k39EuqVQN1TxuLzbj.ixVUJG5JVLC1Xmb7H.',
...
values (
	'faturamento', null, '$2y$12$2PQhqek7WMs5twKXbCOIC.VbEM.JOYh7oivX87iCZ7kBOjwEq8IUS',
